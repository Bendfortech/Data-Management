      ...
      <div className="page-shell">
        ...
        <section className="hero">
          <div className="hero-copy">
            <span className="eyebrow">Advanced technologies for hosting & development</span>
            <h1>Power digital products with custom web, software, design, and VPS services.</h1>
            <p>
              Quantum builds fast websites, enterprise-grade apps, modern UI/UX systems, and secure
              virtual servers so your business can scale with confidence.
            </p>
        ...
        <section id="about" className="about">
          <div className="about-copy">
            ...
            <p>
              From responsive landing pages to backend systems and managed cloud servers, our team
              delivers modern products for agencies, startups, and technical teams.
            </p>
